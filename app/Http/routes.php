...
$router->post('solver_top_plays/add_or_remove_lineup/{playerPoolId}/{hash}/{totalSalary}/{buyIn}/{addOrRemove}/{time}', 'SolverFdNbaController@addOrRemoveLineup'); // {time} is to stop caching
