...
$router->post('scrapers/dk_mlb_contest', 'ScrapersController@dkMlbContest');
...
$router->get('scrapers/dk_mlb_contest', function() {
	return View::make('scrapers/dk_mlb_contest');
});
